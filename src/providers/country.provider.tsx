...
const CountryDataContext = createContext<CountryDataContextProps | undefined>(
  undefined
);
...
export const CountryDataProvider = ({ children }: CountryDataProviderProps) => {
  ...
  const filterByContinent = (continent: string) => {
    // resetCountryData();
    if (!countryData) return null;
    setCountryData(data.filter((country) => country.region === continent));
  };
  return (
